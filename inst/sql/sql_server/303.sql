...
WHERE C.value_as_concept_id in (45880868,36308589,36308652)
-- End Measurement Criteria
...
WHERE (C.value_as_number >= 0.0000 and C.value_as_number <= 60.0000)
-- End Measurement Criteria
...
WHERE C.value_as_concept_id in (45880868,36310215,36309822,36311005,36309699,36310627,36309106)
-- End Measurement Criteria
