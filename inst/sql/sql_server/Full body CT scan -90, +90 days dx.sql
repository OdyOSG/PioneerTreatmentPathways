...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (45879251,2792841,4061009)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (45879251,2792841,4061009)
...
-- End Measurement Criteria
  ...
  WHERE DATEADD(day,30,OP.OBSERVATION_PERIOD_START_DATE) <= E.START_DATE AND DATEADD(day,30,E.START_DATE) <= OP.OBSERVATION_PERIOD_END_DATE
) P
WHERE P.ordinal = 1
-- End Primary Events
