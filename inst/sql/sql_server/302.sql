...
WHERE C.value_as_concept_id in (36310827,36309245)
-- End Measurement Criteria
...
WHERE (C.value_as_number >= 70.0000 and C.value_as_number <= 80.0000)
-- End Measurement Criteria
...
WHERE C.value_as_concept_id in (36310675,36308530)
-- End Measurement Criteria
