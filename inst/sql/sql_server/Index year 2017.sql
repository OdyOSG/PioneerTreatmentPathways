...
select C.person_id, C.observation_period_id as event_id, DATEFROMPARTS(2017, 1, 1) as start_date, DATEFROMPARTS(2018, 1, 1) as end_date,
...
AND C.OBSERVATION_PERIOD_START_DATE <= DATEFROMPARTS(2018, 1, 1) and C.OBSERVATION_PERIOD_END_DATE >= DATEFROMPARTS(2018, 1, 1)
