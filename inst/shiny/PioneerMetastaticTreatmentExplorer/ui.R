...
dashboardPage(
  ...
  dashboardSidebar(
    ...
    sidebarMenu(id = "tabs",
                ...
                if (length(andrData$cohort_count) > 0) addInfo(menuItem("Cohort Counts", tabName = "cohortCounts"), "cohortCountsInfo"),
                if (length(andrData$covariate_value) > 0) addInfo(menuItem("Cohort Characterization", tabName = "cohortCharacterization"), "cohortCharacterizationInfo"),
