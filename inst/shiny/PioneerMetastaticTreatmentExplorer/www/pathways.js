$(document).ready(function(){
  Shiny.addCustomMessageHandler('jsondata', function(message) {
    ...
    const svg = d3.select("#pathwaysD3").append("svg")
    ...
    data.forEach(function (d) {
          graph.nodes.push({ "id"     : d.sourceId.toString(),
                             "name"   : d.sourceName });
          graph.nodes.push({ "id"     : d.targetId.toString(),
                             "name"   : d.targetName });
          graph.links.push({ "source" : d.sourceId.toString(),
